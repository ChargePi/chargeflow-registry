...
func (_m *MockCache) Get(ctx context.Context, key string) (*schema.Schema, error) {
	ret := _m.Called(ctx, key)
...
func (_c *MockCache_Get_Call) Return(_a0 *schema.Schema, _a1 error) *MockCache_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCache_Get_Call) RunAndReturn(run func(context.Context, string) (*schema.Schema, error)) *MockCache_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Set provides a mock function with given fields: ctx, key, _a2
func (_m *MockCache) Set(ctx context.Context, key string, _a2 *schema.Schema) error {
...
//   - key string
//   - _a2 *schema.Schema
func (_e *MockCache_Expecter) Set(ctx interface{}, key interface{}, _a2 interface{}) *MockCache_Set_Call {
	return &MockCache_Set_Call{Call: _e.mock.On("Set", ctx, key, _a2)}
}

func (_c *MockCache_Set_Call) Run(run func(ctx context.Context, key string, _a2 *schema.Schema)) *MockCache_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*schema.Schema))
	})
	return _c
}
...
func (_c *MockCache_Set_Call) RunAndReturn(run func(context.Context, string, *schema.Schema) error) *MockCache_Set_Call {
	_c.Call.Return(run)
	return _c
}
